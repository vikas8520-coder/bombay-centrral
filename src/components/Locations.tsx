...
export default function Locations() {
  return (
    <section id="locations" className="relative bg-[#0a0908]/85 backdrop-blur-sm py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {locations.map((loc, i) => (
            <div
              key={loc.name}
              className="tilt-card group relative overflow-hidden rounded-3xl border border-[#1f1c18] bg-gradient-to-b from-[#1f1c18]/60 to-[#141210]/40 p-8 backdrop-blur-sm"
            >
