export default function About() {
  return (
    <section id="about" className="relative overflow-hidden bg-[#0a0908]/85 backdrop-blur-sm py-24">
      {/* Dot pattern */}
      <div
        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={stat.label}
                className="tilt-card rounded-2xl border border-[#1f1c18] bg-[#1f1c18]/30 p-6 text-center backdrop-blur-sm"
              >
