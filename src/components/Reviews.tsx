...
export default function Reviews() {
  return (
    <section id="reviews" className="relative bg-[#0a0908]/85 backdrop-blur-sm py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {reviews.map((review, i) => (
            <div
              key={i}
              className="tilt-card group relative overflow-hidden rounded-2xl border border-[#1f1c18] bg-[#1f1c18]/60 p-6 backdrop-blur-sm"
            >
              {/* Quote mark */}
